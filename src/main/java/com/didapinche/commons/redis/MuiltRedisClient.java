 ...
 */
public final class MuiltRedisClient extends AbstractRedisClient{
    private static final Logger logger = LoggerFactory.getLogger(MuiltRedisClient.class);


    private MuiltRedisPool pool;
    ...
    public void setPool(MuiltRedisPool pool) {
        this.pool = pool;
    }
}
