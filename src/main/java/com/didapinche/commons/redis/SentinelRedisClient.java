 ...
 */
public final class SentinelRedisClient extends AbstractRedisClient{

    private static Logger logger = LoggerFactory.getLogger(SentinelRedisClient.class);
    ...
    public RedisSentinelPool getRedisSentinelPool() {
        return redisSentinelPool;
    }

    public void setRedisSentinelPool(RedisSentinelPool redisSentinelPool) {
